...
import { BiBookBookmark, BiTask } from 'react-icons/bi'
...
export default function Section4({ section }) {
  ...
  { name: 'Claude', icon: SiAnthropic, url: 'https://claude.ai'},
  { name: 'Cursor', icon: SiCursor, url: 'https://www.cursordev.com/'},
  { name: 'Lovable', icon: BiCodeAlt, url: 'https://www.lovable.ai/'},
  { name: 'Perplexity', icon: TbApi, url: 'https://www.perplexity.ai/'},
  { name: 'Codex', icon: SiOpenai, url: 'https://openai.com/product/codex'},
  { name: 'Trae', icon: BiCodeAlt, url: 'https://www.trae.com/'},
  { name: 'Github Copilot', icon: SiGithub, url: 'https://github.com/features/copilot'},
    ]
  }
