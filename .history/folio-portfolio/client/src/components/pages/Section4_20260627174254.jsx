...
import { 
  ...
  SiExpress ,SiOpenai, SiClaude, SiCursor, SiLovable, SiPerplexity, SiCodex, SiTrae, SiGithub
} from 'react-icons/si'
...
export default function Section4({ section }) {
  ...
  const techStack = {
    ...
    AI: [
      { name: 'ChatGPT', icon: BiCodeAlt, url: 'https://chat.openai.com/'},
      {name: 'Claude', icon: BiCodeAlt, url: 'https://openai.com/product/Claude'},
      {name: 'Cursor', icon: BiCodeAlt, url: 'https://www.cursordev.com/'},
      {name: 'Lovable', icon: BiCodeAlt, url: 'https://www.lovable.ai/'},
      {name: 'Perplexity', icon: BiCodeAlt, url: 'https://www.perplexity.ai/'},
      {name: 'Codex', icon: BiCodeAlt, url: 'https://openai.com/product/codex'},
      {name: 'Trae', icon: BiCodeAlt, url: 'https://www.trae.com/'},
