...
export default function Section1({ section }) {
  ...
  return (
    ...
    >
      ...
      >
        Wlecome to My Portfolio, where I showcase my passion for crafting exceptional digital experiences. With a keen eye for design and a commitment to innovation, I bring ideas to life through clean code and intuitive interfaces. Explore my projects and let's create something amazing together.
      </motion.p>
    </motion.section>
  )
}
