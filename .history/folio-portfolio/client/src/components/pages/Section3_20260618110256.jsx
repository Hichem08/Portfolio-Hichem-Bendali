...
export default function Section3({ section }) {
  ...
  const programmingIcons = [
    ...
    { id: 1, icon: '⚛️', label: 'React', x: 10, y: 25 },
    { id: 2, icon: '🐍', label: 'Python', x: 85, y: 15 },
    { id: 3, icon: '☕', label: 'JavaScript', x: 20, y: 75 },
    { id: 4, icon: '🟦', label: 'TypeScript', x: 75, y: 70 },
    { id: 5, icon: '🎨', label: 'CSS', x: 50, y: 10 },
    { id: 6, icon: '🦀', label: 'Rust', x: 15, y: 50 },
    { id: 7, icon: '🔵', label: 'Node.js', x: 80, y: 40 },
    { id: 8, icon: '⚡', label: 'Vue', x: 45, y: 60 },
    { id: 9, icon: '🟠', label: 'Angular', x: 30, y: 85 },
    { id: 10, icon: '🐬', label: 'PHP', x: 70, y: 25 },
  ]
  ...
  const services = [
    {
      ...
      images: [
        'https://via.placeholder.com/500x400/1a1a1a/ff5722?text=Software+Dev+1',
        'https://via.placeholder.com/500x400/1a1a1a/ff5722?text=Software+Dev+2',
        'https://via.placeholder.com/500x400/1a1a1a/ff5722?text=Software+Dev+3',
      ],
    ...
    },
    {
      ...
      images: [
        'https://via.placeholder.com/500x400/1a1a1a/ff5722?text=Graphic+Design+1',
        'https://via.placeholder.com/500x400/1a1a1a/ff5722?text=Graphic+Design+2',
        'https://via.placeholder.com/500x400/1a1a1a/ff5722?text=Graphic+Design+3',
      ],
    ...
    },
    {
      ...
      images: [
        'https://via.placeholder.com/500x400/1a1a1a/ff5722?text=Solar+Energy+1',
        'https://via.placeholder.com/500x400/1a1a1a/ff5722?text=Solar+Energy+2',
        'https://via.placeholder.com/500x400/1a1a1a/ff5722?text=Solar+Energy+3',
      ],
      link: '/solar-details'
    },
  ]
  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 2 }}>
        ...
        >
          <h2 style={{ fontSize: '72px', marginBottom: '20px' }}>
