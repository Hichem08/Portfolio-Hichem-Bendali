...
import { 
  ...
  SiExpress , SiOpenai , SiCodex, SiClaude, SiCursor, SiLovable, SiPerplexity, 
} from 'react-icons/si'
...
export default function Section4({ section }) {
  ...
  const techStack = {
    ...
    AI: [
      ...
      {name: 'Lovable', icon: SiLovable},
      {name: 'Perplexity', icon: SiPerplexity},
      {name: 'Codex', icon: SiCodex },
      {name: 'Trae', icon: SiTrae},
      {name: 'Github Copilot', icon: BiCodeAlt},
    ]
  }
