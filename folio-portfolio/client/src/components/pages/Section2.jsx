...
const initialDiplomaImages = [
  {
    src: "/images/can.jpeg",
    alt: "AEC Diploma - Cégep du Canada"
  },
  {
    src: "/images/b.jpeg",
    alt: "Bachelor's Degree - 3IL Limoges"
  },
  {
    src: "/images/sol.jpeg",
    alt: "Solar Energy Technician Certificate"
  }
]
              ...
              {diplomas.map((diploma, idx) =>
                diploma.src ? (
                  <button
                    key={idx}
                    type="button"
                    className="diploma-slot has-image"
                    title={`View ${diploma.alt}`}
