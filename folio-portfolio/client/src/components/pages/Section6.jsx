  ...
  const solarItems = [
    {
      ...
      description:
        'Professional installation of photovoltaic solar panels for residential and commercial properties. Maximize your energy production with our expertly designed systems.',
    },
    {
      image: solar2,
      title: 'Solar Maintenance & Repair',
      description:
        'Comprehensive maintenance services to keep your solar system operating at peak efficiency. Regular inspections and repairs for long-lasting performance.',
    },
  ]
    ...
    return (
      ...
      >
        <div className={`solar-grid ${isReversed ? 'reversed' : ''}`}>
          <motion.div
            className="solar-image-wrap tech-card animated-border"
